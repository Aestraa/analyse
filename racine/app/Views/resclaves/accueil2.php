...
//ajout des points au cluster
    ...
    "<form id='formulaire' action='<?= base_url();?>/map/places' method='post'>"+
   " <button id='bouton' type='submit' name ='select_place' value="+ lieu +"> <p id='pop_carte'>Visualiser les autres lieux similaires<br>"+ lieu +"</p>" +
   "</button></form>"
              ),
